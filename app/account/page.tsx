    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-gray-900 text-white">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-8">
          ...
          <section className="grid flex-1 items-center gap-8 py-14 lg:grid-cols-[1fr_420px]">
            ...
            <aside className="rounded-[28px] border border-white/10 bg-white/[0.07] p-6 shadow-2xl shadow-cyan-950/40 backdrop-blur-2xl sm:p-8">
