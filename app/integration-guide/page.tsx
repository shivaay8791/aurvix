        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-7">
          ...
          <section className="py-12">
            ...
            <div className="mt-10 rounded-2xl border border-cyan-400/20 bg-cyan-500/10 p-5">
              <h2 className="text-xl font-bold">Recommended first flow</h2>
              ...
              <Link
                ...
                className="mt-6 inline-flex rounded-xl bg-cyan-400 px-4 py-2.5 text-sm font-bold text-black transition hover:bg-cyan-300"
              >
                Open Resume Builder
              </Link>
            </div>
